...
// jquery  点击切换背景色*/
    ...
    layui.use('element', function () {
        ...
        $('.site-demo-active2').click(function () {

            // window.parent.parent.active1($(this));
            var frame = document.getElementById('myfarme');
            // var frame=$('#myfarme');
            // console.log(frame.parent().find('.H105_top1 '));
            // frame.parent.active1($(this))

            // window.parent.frame.contentWindow.postMessage("delete",'*');

            // alert("window.name"+window.name);
        });
        // if( parent.getQueryVariable("type")=="2")
        //{
        //
        //	 setStyleMenu();
        //
